...
***- Менеджер проекту:*** Людина, яка керує проектом. А саме отримує та опрацьовує замовлення, взаємодіє з тімлідом, тим самим контролює через нього етапи розробки системи. Окрім цього бере до уваги всі побажання замовника. Одночасно це людина, яка може контролювати велику кількість розробників, організовує етапи роботи та розподіл завдань між учасниками групи. Менеджер взаємодіє з замовником та керівником групи.

***- Тімлід:*** Людина, яка керує командою програмістів. А саме розподіляє завдання в групі між розробниками і весь час контролює їх виконання, відповідає за технічну складову проекту. Тімлід - висококваліфікований програміст. Взаємодіє з проектним менеджером та розробниками.

***- Розробник:*** Спеціаліст або декілька спеціалістів, котрий(котрі) займаються розробкою проекту. Реалізовує(-ють) поставлені тімлідом завдання. Взаємодіє з тестувальником та керівником групи.
