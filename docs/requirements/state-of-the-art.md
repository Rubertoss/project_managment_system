...
Принциповою відмінністю дешбордів від таблиць та звітів є його форма. Дуже часто дешборди постають у вигляді "плиток", що відображають певну інформацію у реальному часі. Дешборди можна виводити на екран та надавати до них доступ іншим користувачам(членам команди), що працюють над проэктом, щоб бачити зміни в статусі його етапів та плануванні.
...
Провівши аналіз систем управління проектами, ми визначили недоліки кожної з систем, наша команда дійшла висновку, що  кращим рішенням буде створення нової системи управління проектами, яка буде мати можливість інтеграції з GitHub, низький поріг входження, буде включати всі переваги проаналізованих систем з доповненням важливих безкоштовних функцій: достатній загальний обсяг пам'яті, багатомовність, командний чат, резервне копіювання даних, інтуїтивно зрозумілий інтерфейс, to do lists, кросплатформеність, захист даних , зручний онлайн-доступ та будуть задовольняти функціональні та інші потреби замовника.